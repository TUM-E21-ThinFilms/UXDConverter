...
class Ui_UXDConverter(object):
    def setupUi(self, UXDConverter):
        ...
        self.gridLayout_18.addWidget(self.label_12, 0, 1, 1, 1)
        self.input_wavelength_error = QtWidgets.QLineEdit(self.groupBox_8)
        self.input_wavelength_error.setObjectName("input_wavelength_error")
        self.gridLayout_18.addWidget(self.input_wavelength_error, 0, 2, 1, 1)
        self.label_13 = QtWidgets.QLabel(self.groupBox_8)
        self.label_13.setObjectName("label_13")
        self.gridLayout_18.addWidget(self.label_13, 1, 1, 1, 1)
        self.input_theta_error = QtWidgets.QLineEdit(self.groupBox_8)
        self.input_theta_error.setObjectName("input_theta_error")
        self.gridLayout_18.addWidget(self.input_theta_error, 1, 2, 1, 1)
        ...
        self.checkbox_plotLogScale = QtWidgets.QCheckBox(self.groupBox_7)
        self.checkbox_plotLogScale.setChecked(True)
        self.checkbox_plotLogScale.setObjectName("checkbox_plotLogScale")
        self.gridLayout_22.addWidget(self.checkbox_plotLogScale, 0, 1, 1, 1)
        ...
        self.conversion_input_wavelength = QtWidgets.QLineEdit(self.groupBox_9)
        ...
        self.conversion_wavelength = QtWidgets.QRadioButton(self.groupBox_9)
        ...
        self.conversion_energy = QtWidgets.QRadioButton(self.groupBox_9)
        self.conversion_energy.setObjectName("conversion_energy")
        self.gridLayout_21.addWidget(self.conversion_energy, 1, 0, 1, 1)
        self.conversion_input_energy = QtWidgets.QLineEdit(self.groupBox_9)
        ...
        self.pushButton_toSettings = QtWidgets.QPushButton(self.groupBox_9)
        ...
        self.gridLayout_21.addItem(spacerItem5, 0, 3, 1, 1)
        ...
        self.gridLayout_25.addItem(spacerItem6, 0, 2, 1, 1)
        ...
        self.gridLayout_25.addItem(spacerItem7, 0, 5, 1, 1)
        ...
        self.gridLayout_13.addWidget(self.groupBox_10, 2, 0, 1, 1)
        ...
        self.gridLayout_10.addItem(spacerItem8, 1, 3, 1, 1)
    ...
    def retranslateUi(self, UXDConverter):
        ...
        self.lineEdit_wavelength.setText(_translate("UXDConverter", "1,5406"))
        ...
        self.groupBox_8.setTitle(_translate("UXDConverter", "Errors"))
        self.label_12.setText(_translate("UXDConverter", "<html><head/><body><p>Error wavelength [&#8491;]</p></body></html>"))
        self.input_wavelength_error.setText(_translate("UXDConverter", "1,0e-2"))
        self.label_13.setText(_translate("UXDConverter", "<html><head/><body><p>Error theta [deg]</p></body></html>"))
        self.input_theta_error.setText(_translate("UXDConverter", "9,585e-3"))
        ...
        self.groupBox_7.setTitle(_translate("UXDConverter", "Plotting settings"))
        self.label_11.setText(_translate("UXDConverter", "log y - Axis"))
        self.checkbox_plotLogScale.setText(_translate("UXDConverter", "Enabled"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("UXDConverter", "Settings"))
        self.groupBox_9.setTitle(_translate("UXDConverter", "Wavelength"))
        self.conversion_input_wavelength.setText(_translate("UXDConverter", "1.5418"))
        self.conversion_wavelength.setText(_translate("UXDConverter", "Wavelength [A⁻1]"))
